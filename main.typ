...
#let skills_de_moi = grid(
  ...
  // 核心技能 (High Priority for Prof. Chen)
  text(weight: "bold")[ROS2], [熟练使用 ROS2 设计机器人控制程序；具备 SLAM、导航与运动规划基础],

  text(weight: "bold")[机器视觉], [深入掌握计算机视觉技术 (OpenCV)，应用于目标检测、分割及三维重建],

  text(weight: "bold")[嵌入式开发], [熟练使用C语言进行 STM32 单片机程序设计；掌握 KiCAD/嘉利创进行原理图/PCB设计],
...
#let projects = (
  ...
  (
    ...
    text(weight: "bold")[浙江省大学生工程实践与创新能力大赛 智能物流 (全国特等奖)],
    "2024.11-2025.08",
  ...
  (
    ...
    text(weight: "bold")[浙江省大学生机器人竞赛 - 水下目标三维重建 (冠军)],
    "2025.05",
  ...
  (
    ...
    text(weight: "bold")[国家级大学生创新创业项目 - 海洋建筑裂缝检测与修补],
    "2023 - 2025",
    "研发水下机器人，实现海洋建筑裂缝检测与自动修补",
    "项目成功结题，产出论文一篇",
    "负责机器人结构设计及视觉程序开发，实现裂缝检测、辅助水下定位与场景重建",
